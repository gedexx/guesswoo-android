...
@EFragment(R.layout.fragment_profile_informations)
public class ProfileInformationsFragment extends Fragment {
     ...
     * @return
     */
    public static ProfileInformationsFragment newInstance() {
        ProfileInformationsFragment fragment = new ProfileInformationsFragment();
     ...
     */
    public ProfileInformationsFragment() {
    }
